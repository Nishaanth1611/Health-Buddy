...
def main(args):
    ...
    d = DiagnosisClient(username="r5C7Y_GMAIL_COM_AUT",language="en-gb",healthServiceUrl="https://healthservice.priaid.ch",authServiceUrl="https://authservice.priaid.ch/login",password="n5RWs47Mfe3Y6EyXq")
